...
/* harmony import */ var _manage_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./manage.page */ "./src/app/manage/manage.page.ts");
...
var routes = [
    {
        path: '',
        component: _manage_page__WEBPACK_IMPORTED_MODULE_5__["ManagePage"]
    }
];
var ManagePageModule = /** @class */ (function () {
    ...
    ManagePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_manage_page__WEBPACK_IMPORTED_MODULE_5__["ManagePage"]]
        })
    ], ManagePageModule);
...
module.exports = "mat-grid-tile {\n  background: lightblue; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ManagePage = /** @class */ (function () {
    function ManagePage(dishService, sessionService) {
    ...
    ManagePage.prototype.ngOnInit = function () {
        ...
        if (user != "") {
            this.sessionService.GetSessionAccess(user).subscribe(function (response) {
                ...
                _this.dishService.GetAllDishesId(response[0].userId).subscribe(function (response) {
                    _this.dish = response;
                    console.log(response);
                });
    ...
    ManagePage.prototype.drop = function (event) {
    ...
    ManagePage.prototype.publish = function (id) {
        console.log("Publish id " + id);
        var data = { "publishStatus": 1 };
        this.dishService.UpdateDishById(id, data).subscribe(function (response) {
            console.log(response);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()("#p" + id).fadeOut(1);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()("#u" + id).fadeIn(1);
        }, function (err) {
            console.log(err);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()("#p" + id).fadeOut(1);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()("#u" + id).fadeIn(1);
    ...
    ManagePage.prototype.unpublish = function (id) {
        console.log("Publish id " + id);
        var data = { "publishStatus": 0 };
        this.dishService.UpdateDishById(id, data).subscribe(function (response) {
            console.log(response);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()("#p" + id).fadeIn(1);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()("#u" + id).fadeOut(1);
        }, function (err) {
            console.log(err);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()("#p" + id).fadeIn(1);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()("#u" + id).fadeOut(1);
    ...
    ManagePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_dish_dish_service__WEBPACK_IMPORTED_MODULE_5__["DishService"], _shared_Session_session_service__WEBPACK_IMPORTED_MODULE_6__["SessionService"]])
    ], ManagePage);
    return ManagePage;
}());
