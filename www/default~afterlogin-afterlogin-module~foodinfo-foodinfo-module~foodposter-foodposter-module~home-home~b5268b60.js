(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~afterlogin-afterlogin-module~foodinfo-foodinfo-module~foodposter-foodposter-module~home-home~b5268b60"],{
...
var SessionService = /** @class */ (function () {
    ...
    SessionService.prototype.CreateSession = function (data) {
        return this.http.post(this.baseurl + '/createSession', JSON.stringify(data), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    };
    // GET
    SessionService.prototype.GetIssue = function (id) {
    ...
    // GET
    SessionService.prototype.GetSessionAccess = function (id) {
        return this.http.get(this.baseurl + '/getSessionByAccessToken?accessToken=' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    };
    // GET
    SessionService.prototype.GetIssues = function () {
        return this.http.get(this.baseurl + '/bugtracking/')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    };
    // PUT
    SessionService.prototype.UpdateBug = function (id, data) {
        return this.http.put(this.baseurl + '/bugtracking/' + id, JSON.stringify(data), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    };
    // DELETE
    SessionService.prototype.DeleteBug = function (id) {
        return this.http.delete(this.baseurl + '/bugtracking/' + id, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    };
    // Error handling
    SessionService.prototype.errorHandl = function (error) {
        var errorMessage = '';
...
//# sourceMappingURL=default~afterlogin-afterlogin-module~foodinfo-foodinfo-module~foodposter-foodposter-module~home-home~b5268b60.js.map